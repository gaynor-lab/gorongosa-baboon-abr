...
combined_fixed_vigilance_predator_plot <- ggplot() +
  ...
  # Model predictions 
  geom_point(
    data = vigilance_fixed_pred_only,
...
#vigilance by year
combined_fixed_vigilance_year_plot <- ggplot() +
  # Boxplot with jittered raw data
  geom_boxplot(
    data = Baboon_vigilance_stats_both,
  ...
  geom_point(
    data = vigilance_fixed_year_only,
...
combined_fixed_vigilance_habitat_plot <- ggplot() +
  # Boxplot with jittered raw data
  geom_boxplot(
    data = Baboon_vigilance_stats_both,
  ...
  # Model predictions (points + error bars)
  geom_point(
    data = vigilance_fixed_habitat_only,
...
combined_fixed_vigilance_prey_plot <- ggplot() +
  # Boxplot with jittered raw data
  geom_boxplot(
    data = Baboon_vigilance_stats_both,
  ...
  # Model predictions (points + error bars)
  geom_point(
    data = vigilance_fixed_prey_only,
...
combined_fixed_frequency_pred_plot <- ggplot() +
  ...
  geom_point(
    data = frequency_fixed_pred_only,
    aes(x = predator_cue, y = predicted, color = "Predicted"),
    size = 3,
    position = position_dodge(width = 0.9)
  ) +
...
# Flight by year
combined_fixed_frequency_year_plot <- ggplot() +
  # Observed bar plot (no error bars)
  geom_bar(
  ...
  geom_point(
    data = frequency_fixed_year_only,
    aes(x = year, y = predicted, color = "Predicted"),
    size = 3,
...
# Flight by habitat
combined_fixed_frequency_habitat_plot <- ggplot() +
  # Observed bar plot (no error bars)
  geom_bar(
  ...
  # Predicted values with CI
  geom_point(
    data = frequency_fixed_habitat_only,
    aes(x = habitat, y = predicted, color = "Predicted"),
    size = 3,
    position = position_dodge(width = 0.6)
  ) +
...
combined_fixed_frequency_prey_plot <- ggplot() +
  ...
  geom_point(
    data = frequency_fixed_prey_only,
    aes(x = age_sex_class, y = predicted, color = "Predicted"),
    size = 3,
    position = position_dodge(width = 0.6)
  ) +
